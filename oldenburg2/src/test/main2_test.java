...
public class main2_test {
	public static final int node = 8;// OL.cnode100.txt  1000
	public static final int edge = 8;// OL.cedge100.txt 1152
	public static final int dimasion = 2;
	public static final String nodeFile = "./data/small/1111n.txt";
	public static final String edgeFile = "./data/small/1111e.txt";
	...
	public static int rangeNum = 9;// level range
