...
public class Dijkstra {
   private static final Graph.Edge[] GRAPH = {
      new Graph.Edge(1, 2, 7),
      new Graph.Edge(1, 3, 9),
      new Graph.Edge(1, 6, 14),
      new Graph.Edge(2, 3, 10),
      new Graph.Edge(2, 4, 15),
      new Graph.Edge(3, 4, 11),
      new Graph.Edge(3, 6, 2),
      new Graph.Edge(4, 5, 6),
      new Graph.Edge(5, 6, 9),
   };
